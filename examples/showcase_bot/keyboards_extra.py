...
def error_demo_menu_kb() -> InlineKeyboardMarkup:
    ...
    kb.add(
        KeyboardButton(
            text="APIError -- редактирование несуществующего",
            callback_data="err:api",
            style=StyleKeyboard.PRIMARY,
        ),
        KeyboardButton(
            text="Иерархия ошибок",
            callback_data="err:hierarchy",
            style=StyleKeyboard.PRIMARY,
        ),
        KeyboardButton(
            text="Безопасный try/except",
            callback_data="err:safe",
            style=StyleKeyboard.PRIMARY,
        ),
    )
...
def chat_admin_menu_kb() -> InlineKeyboardMarkup:
    ...
    kb.add(
        ...
        KeyboardButton(
            text="Участники чата (пагинация)",
            callback_data="adm:members",
            style=StyleKeyboard.PRIMARY,
        ),
        KeyboardButton(
    ...
    kb.add(
        KeyboardButton(
            text="Изменить название чата", callback_data="adm:title", style=style
        ),
        KeyboardButton(
            text="Изменить описание чата", callback_data="adm:about", style=style
        ),
        KeyboardButton(
            text="Изменить правила чата", callback_data="adm:rules", style=style
        ),
    )
    kb.row(KeyboardButton(text="<< В главное меню", callback_data="menu:main"))
    return kb
...
def admin_confirm_kb(action: str) -> InlineKeyboardMarkup:
    ...
    kb.add(
        KeyboardButton(
            text="Подтвердить",
            callback_data=f"adm:confirm:{action}",
            style=StyleKeyboard.PRIMARY,
        ),
        KeyboardButton(
            text="Отмена", callback_data="menu:adm", style=StyleKeyboard.ATTENTION
        ),
    )
    return kb
